 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PredictPrice($region: Region!, $temperature: Int!, $humidity: Int!) {\n  predictPrice(region: $region, temperature: $temperature, humidity: $humidity) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}\n\nquery PredictionHistory($region: Region, $startDate: String, $endDate: String) {\n  predictionHistory(region: $region, startDate: $startDate, endDate: $endDate) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}\n\nmutation SubmitInput($input: PredictionInput!) {\n  submitInput(input: $input) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}"): (typeof documents)["query PredictPrice($region: Region!, $temperature: Int!, $humidity: Int!) {\n  predictPrice(region: $region, temperature: $temperature, humidity: $humidity) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}\n\nquery PredictionHistory($region: Region, $startDate: String, $endDate: String) {\n  predictionHistory(region: $region, startDate: $startDate, endDate: $endDate) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}\n\nmutation SubmitInput($input: PredictionInput!) {\n  submitInput(input: $input) {\n    id\n    region\n    temperature\n    humidity\n    predictedPrice\n    timestamp\n  }\n}"];
